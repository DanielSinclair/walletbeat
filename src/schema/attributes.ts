...
export type ValueSet = OutcomeMetadataSet
 ...
 * attribute group.
 */
export interface AttributeGroup<Ms extends ValueSet> {
 ...
 */
export type EvaluatedGroup<Ms extends ValueSet> = {
	[K in keyof Ms]: EvaluatedAttribute<Ms[K]>
}
 ...
 */
export function evaluatedAttributes<Ms extends ValueSet>(
	evaluatedGroup: EvaluatedGroup<Ms>,
 ...
 */
export function evaluatedAttributesEntries<Ms extends ValueSet>(
	evaluatedGroup: EvaluatedGroup<Ms>,
): NonEmptyArray<[keyof Ms, EvaluatedAttribute<OutcomeMetadata>]> {
	// eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- We know that ValueSets cannot be empty, therefore neither can this array.
	return Object.entries(evaluatedGroup) as unknown as NonEmptyArray<
		[keyof Ms, EvaluatedAttribute<OutcomeMetadata>]
	>
}
